const translations = {
  ...
  "pricing.free.f1": { en: "Up to 3 agents", es: "Hasta 3 agentes" },
  "pricing.free.f2": { en: "1 workspace", es: "1 workspace" },
  "pricing.free.f3": { en: "100 tickets/month", es: "100 tickets/mes" },
  "pricing.free.f4": { en: "Community support", es: "Soporte comunitario" },

  "pricing.team.name": { en: "Team", es: "Equipo" },
  "pricing.team.desc": { en: "For growing teams", es: "Para equipos en crecimiento" },
  "pricing.team.cta": { en: "Start Free Trial", es: "Iniciar Prueba Gratis" },
  "pricing.team.f1": { en: "Up to 10 agents", es: "Hasta 10 agentes" },
  "pricing.team.f2": { en: "3 workspaces", es: "3 workspaces" },
  "pricing.team.f3": { en: "Unlimited tickets", es: "Tickets ilimitados" },
  "pricing.team.f4": { en: "Email support", es: "Soporte por email" },

  "pricing.business.name": { en: "Business", es: "Negocio" },
  "pricing.business.desc": { en: "For scaling organizations", es: "Para organizaciones en crecimiento" },
  "pricing.business.cta": { en: "Start Free Trial", es: "Iniciar Prueba Gratis" },
  "pricing.business.f1": { en: "Up to 25 agents", es: "Hasta 25 agentes" },
  "pricing.business.f2": { en: "Unlimited workspaces", es: "Workspaces ilimitados" },
  "pricing.business.f3": { en: "Public portal", es: "Portal público" },
  "pricing.business.f4": { en: "Analytics dashboard", es: "Dashboard de analíticas" },
  "pricing.business.f5": { en: "Priority support", es: "Soporte prioritario" },
